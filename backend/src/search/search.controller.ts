...
export class SearchController {
  ...
  @ApiQuery({ name: 'category', required: false, description: 'Filter marketplace results by category' })
  @ApiQuery({ name: 'specialty', required: false, description: 'Filter doctor results by specialty' })
  ...
  async search(
    ...
    return this.searchService.search(user.sub, q, type, { category, specialty });
  }
}
