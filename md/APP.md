...
| State | Redux Toolkit + RTK Query (25 API slices) |
...
│   │   ├── video-call.tsx            # Video call (Agora SDK, frontend TODO)
...
### Redux Store (25 API Slices + 1 Auth Slice)
...
├── addressesApi — CRUD for user's addresses
